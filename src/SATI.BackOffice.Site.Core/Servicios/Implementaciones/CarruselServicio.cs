...
{
    public class CarruselServicio:Servicio<Carousel>, ICarruselServicio
    {
        private readonly static string RUTA_ENTIDAD = "/api/BOCarrusel";
        private readonly static string CALCULAR_RUTA = "/CalcularRuta";
        private readonly AppSettings _appSettings;
        private readonly ILoggerHelper _logger;

        public CarruselServicio(IOptions<AppSettings> options, ILoggerHelper logger) : base(options, logger, RUTA_ENTIDAD) 
        {
